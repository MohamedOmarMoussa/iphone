...
This GitHub repository features a replica of Apple's iPhone 15 Pro website built with React.js and TailwindCSS. It showcases the utilization of GSAP (Greensock Animations) and Three.js for presenting dynamic iPhone 15 Pro models in diverse colors and shapes.
...
```bash
git clone https://github.com/MohamedOmarMoussa/iphone.git
cd iphone
```
